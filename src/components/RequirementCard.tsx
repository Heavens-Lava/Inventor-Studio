 ...
 */
export const RequirementCard = memo(({ data, selected, id }: NodeProps<RequirementNodeData>) => {
        ...
        <div className="flex items-start justify-between gap-2 mb-2">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            {isEditingTitle ? (
              ...
              <h3
                className="font-semibold text-sm cursor-text hover:bg-gray-100 px-1 rounded"
        ...
        {(data.description || isEditingDescription) && (
          isEditingDescription ? (
            <Textarea
              ...
              className="text-xs min-h-[40px] nodrag mb-2"
              onClick={(e) => e.stopPropagation()}
              rows={2}
            />
          ) : (
            <p
              className="text-xs text-gray-600 mb-2 line-clamp-2 cursor-text hover:bg-gray-100 px-1 rounded"
